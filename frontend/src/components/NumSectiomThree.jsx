        ...
        <div className='flex items-center justify-between flex-wrap gap-[30px]'>
            <div className="w-[450px]">
                <div className="w-16 h-16 background-gradient4 rounded-full shadow justify-center items-center inline-flex">
                    <p className="text-center text-white text-[42px] leading-[46.20px]">3</p>
                </div>
                <h1 className='m-0 pb-[20px] pt-[29px] max-w-full text-zinc-950 text-[42px] leading-[46.20px]'>Getting updates</h1>
...
export default NumSectiomThree;
